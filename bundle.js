...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */]({
    ...
    methods:{
        ...
        getCurrentUser: function () {
            let {id,createAt,attributes:{username}} = __WEBPACK_IMPORTED_MODULE_1_leancloud_storage___default.a.User.current()
        ...
        updateTodo: function () {
            var todo = __WEBPACK_IMPORTED_MODULE_1_leancloud_storage___default.a.Object.createWithoutData('AllTodos', this.todoList.id);
        ...
        queryCurrentUserTodo: function () {
            let query = new __WEBPACK_IMPORTED_MODULE_1_leancloud_storage___default.a.Query('AllTodos')
            let avTodos
